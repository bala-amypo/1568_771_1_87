...
import com.example.demo.service.impl.ActivityTypeServiceImpl;
...
public class ActivityTypeController {
    ...
    private final ActivityTypeServiceImpl typeService;

    public ActivityTypeController(ActivityTypeServiceImpl typeService) {
